...
{
	m_up_dice_capacity = std::make_unique<DiceCapacity>();
}
...
//void entity::BasePlayerEntity::useCapacity(BaseCapacity& capacity, IEntity& target) {
//	std::cout
//		<< m_name
...
//
//
//void entity::BasePlayerEntity::takeCapacity(const SCapacityModifiers& capacity, const IEntity& source) {
